 ...
 */
export function resolvePrivateTenure(raw) {
    ...
    const psuDegenerate = psuOk && hasSeparator && psu.maxDays != null && psu.maxDays === psu.minDays;
    if (psuOk && !psuDegenerate)
        return psu;
